...
export interface ServerQuotationPDFData {
...
export function generateServerQuotationPDF(data: ServerQuotationPDFData): jsPDF {
  try {
    const doc = new jsPDF();
    ...
    const summary = [
      ...
      ['Room Quotation Total', data.roomQuotationTotal],
